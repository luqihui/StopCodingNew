...
public class StopCodingSettingAction extends AnAction implements ApplicationComponent, ApplicationActivationListener {
    ...
    @Override
    public void applicationActivated(com.intellij.openapi.wm.IdeFrame ideFrame) {
